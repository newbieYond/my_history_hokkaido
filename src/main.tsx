...
function App() {
  ...
  return <main>
    ...
    <section id="top" className="hero"><div className="flakes">✦　·　✧　·　✦　·　✧</div><p className="eyebrow">A WINTER TRAVEL NOTE</p><h1>눈이 오기 전,<br /><em>Hokkaido.</em></h1><div className="hero-bottom"><p>2026. 11. 18 — 11. 24<br />SEOHO & SEIN · 6 NIGHTS, 7 DAYS</p><a href="#itinerary">여행 살펴보기 <span>↓</span></a></div></section>
